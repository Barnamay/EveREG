...
const LogIn = () => {
    ...
    useEffect(() => {
    if (session) {
      router.push('/') // ✅ Redirects only after render
    }
  }, [session, router])
  ...
  if (status === "loading") {
    ...
    return (
        <div className="text-cyan-400 py-20 container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-14">LogIn</h2>
            <div className="text-cyan-400 shadow rounded-4xl divide-y bg-gray-200 w-200 flex justify-center items-start  gap-5 px-4 py-10 container mx-auto">





            <div className="bg-gray-200 shadow w-88 rounded-lg divide-y divide-gray-400 max-w-sm">
            <div className="px-5 py-7">
                <label className="font-semibold text-sm text-indigo-800 pb-1 block">E-mail</label>
                <input type="text" className="border rounded-lg text-blue-800 px-3 py-2 mt-1 mb-5 text-sm w-full" />
                <label className="font-semibold text-sm text-indigo-800 pb-1 block">Password</label>
                <input type="text" className="border rounded-lg text-blue-800 px-3 py-2 mt-1 mb-5 text-sm w-full" />
        ...
        <div className="py-5">
            ...
            <div className="flex flex-col gap-2  items-center p-10 ml-10 mt-2">


                <button onClick={()=>{signIn("google")}}
                    className="flex items-center w-60 bg-blue-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
